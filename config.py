...
# ID do dono do bot usado como fallback para DMs de incidentes importantes de voz.
# Falhas transitórias ficam apenas nos logs; se vazio, usa o owner oficial da aplicação.
